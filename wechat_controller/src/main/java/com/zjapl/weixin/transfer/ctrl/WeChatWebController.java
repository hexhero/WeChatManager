...
public class WeChatWebController {
	...
	@ResponseBody
	public String openidAuth(String code, String state){
		return webAuth(code, state, WeChatEventDict.SCOPE_SNSAPI_BASE);
	}
	...
	@ResponseBody
	public String userinfoAuth(String code, String state){
		return webAuth(code, state, WeChatEventDict.SCOPE_SNSAPI_USERINFO);
	}
	 ...
	 * @return
	 */
	private String webAuth(String code, String state, String scope) {
		...
		if(info != null){
			...
			if(webToken != null && webToken.getOpenid() != null){
				...
				//与子系统通讯,获得子系统的响应结果
				String resultStr = comunication(appinfo,transferData);
				return resultStr;
			}
		}
		return "<h2>页面请求失败</h2>";
